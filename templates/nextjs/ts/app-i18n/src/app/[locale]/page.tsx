...
const App = () => {
  ...
  let description: string = languageText.raw("description");
    ...
    <React.Fragment>
      <div className="h-screen w-full bg-neutral-50 dark:bg-neutral-950 relative flex items-center justify-center">
        ...
        <div className="flex items-center flex-col mx-auto max-md:px-4">
          ...
          <p className="text-sm text-neutral-500  max-w-md text-center my-2" dangerouslySetInnerHTML={{ __html: description }}></p>
