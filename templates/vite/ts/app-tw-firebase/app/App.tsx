...
// Uncomment if you need navigation functionality
      ...
      <div className="h-screen w-full bg-neutral-50 dark:bg-neutral-950 relative flex items-center justify-center">
        ...
        <div className="flex items-center flex-col mx-auto max-md:px-4">
          <div className="flex items-center space-x-8 sm:space-x-16 flex-wrap my-6">
            <span className="">
              <img src="/vite.svg" alt="" className="h-16 sm:h-20" />
            </span>
            <span className="">
              <img
                src={react}
          ...
          <p className="text-sm text-neutral-500 space-y-2 max-w-md text-center my-2 ">
            <span className="">
              start editing :{" "}
          ...
          <p className="text-sm text-neutral-500 space-y-2 max-w-md text-center my-2 ">
            <span className="">Try Browser Router : </span>
